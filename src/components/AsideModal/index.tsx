...
export function AsideModal(){
  ...
  const {setRange,range, showDisplay, handleShowDisplay} = useContext(ParticulesContext);
  const {
  ...
  return (
    ...
    >
      <Content>
        <button onClick={handleShowDisplay}><AiOutlineClose/></button>
        <div className="Parameters-CM">
          ...
          <h3><i>Informações:</i></h3>
          <div className="informationCM">
            <h5><i>CM:</i></h5>
            <h5><i>x: {valueX} m</i></h5>
            <h5><i>y: {valueY} m</i></h5>
            <h5><i>m: {valueM} kg</i></h5>
            <h5><i>F: {valueF} N</i></h5>
            <h5><i>a: {valueA} m/s²</i></h5>
          </div> 
        </div>
        <ParticuleTable/>
      </Content>
