        ...
        <List key={particule.id} isBackground={particule.background}>
          <table>
            <thead>
              <tr>
                <th>
                  <h3 className="particuleColor">
                    <i>{particule.nameParticule}</i>
                  </h3>
                </th>
                <th>
            ...
            <tbody>
              <tr>
                <td>
                  <i>x: {particule.positionX} m</i>
                </td>
                <td>
                  <i>y: {particule.positionY} m</i>
                </td>
              </tr>
              <tr>
                <td>
                  <i>m: {particule.mass} kg</i>
                </td>
                <td>
                  <i>F: {particule.force} N</i>
                </td>
              </tr>
            </tbody>
          </table>
