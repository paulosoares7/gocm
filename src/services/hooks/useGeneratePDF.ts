...
export function useGeneratePDF(){
  ...
  const tablesValues = CM.data[0]
    ...
    const tableParticules = particules.map((particule) => (  
      [  
        {text: ` ${particule.nameParticule}`, italics:true, alignment:"center"}, 
    ...
    const docDefinitions: TDocumentDefinitions = {
      ...
      },
      {
        ...
        table: {
          ...
          headerRows: 1,
          body: [
            [{text: 'Valores:', style: 'tableHeader', italics:true}, {text: '', style: 'tableHeader'}, {text: '', style: 'tableHeader'}],
            [
              {text:`Posição x (m): ${tablesValues.x}`, italics:true}, 
              {text:`Posição y (m): ${tablesValues.y}`, italics:true}, 
              {text:`Mód. da posição (m): ${tablesValues.rCmR}`, italics:true},
            ],
            [
              {text:`Comp. x da Força (N): ${tablesValues.fx}`,italics:true},
              {text:`Comp. y da Força (N): ${tablesValues.fy}`,italics:true}, 
              {text:`Mód. da Força (N): ${tablesValues.fr}`,italics:true},
            ],
            [
              {text: `Comp. x da Acel. (m/s²): ${tablesValues.aCmX}`,italics:true},
              {text: `Comp. y da Acel. (m/s²): ${tablesValues.aCmY}`,italics:true}, 
              {text: `Mód. da Acel. (m/s²): ${tablesValues.aCmR}`,italics:true},
            ],
            [{text: `Massa resultante (Kg): ${tablesValues.mr}`,italics:true}, '', ''],
          ]
        },
        layout: 'noBorders'
      },
      ...
      },
      {
        ...
        table: {
          ...
          body: [
            [
              {text: 'Partícula:', style: 'tableHeader', italics:true, alignment:"center",}, 
              {text: 'x(m):', style: 'tableHeader', italics:true, alignment:"center"}, 
              {text: 'y(m)', style: 'tableHeader',italics:true, alignment:"center"}, 
              {text: 'Grau em rel. a x', style: 'tableHeader',italics:true, alignment:"center"}, 
              {text: 'Força atuante (N)', style: 'tableHeader',italics:true, alignment:"center"},
              {text: 'Massa (Kg)', style: 'tableHeader',italics:true, alignment:"center"},
            ],
            ...tableParticules
      ...
      },
      {
        ...
        table: {
          ...
          body: [
            [
              {text: 'i', style: 'tableHeader', italics:true, alignment:"center",}, 
              {text: 't (s)', style: 'tableHeader', italics:true, alignment:"center"}, 
              {text: 'Mod. da posição (m)', style: 'tableHeader',italics:true, alignment:"center"}, 
              {text: 'Mod. da Velocidade (m/s)', style: 'tableHeader',italics:true, alignment:"center"}, 
              {text: 'Mod. da Aceleração (m/s²)', style: 'tableHeader',italics:true, alignment:"center"},
              {text: 'Energia (J)', style: 'tableHeader',italics:true, alignment:"center"},
            ],
